...
describe("Testing conversion", () => {
    test("exception in case of cyclic conversion rules", () => {
        ...
        const doubleType = typir.factory.Primitives.create({
        ...
        expect(() =>
            ...
            "Adding the conversion from double to integer with mode IMPLICIT_EXPLICIT has introduced a cycle in the type graph.",
        );
    });
});
