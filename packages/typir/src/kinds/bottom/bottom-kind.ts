...
export interface CreateBottomTypeDetails<LanguageType>
    extends BottomTypeDetails<LanguageType> {
...
export interface BottomFactoryService<LanguageType> {
    create(
        typeDetails: BottomTypeDetails<LanguageType>,
    ): BottomConfigurationChain<LanguageType>;
...
interface BottomConfigurationChain<LanguageType> {
    inferenceRule<T extends LanguageType>(
        rule: InferCurrentTypeRule<BottomType, LanguageType, T>,
    ): BottomConfigurationChain<LanguageType>;
    finish(): BottomType;
}
    ...
    implements Kind, BottomFactoryService<LanguageType>
{
    ...
    constructor(
        ...
        options?: Partial<BottomKindOptions>,
    ) {
    ...
    create(
        ...
        return new BottomConfigurationChainImpl(
            this.services,
            this,
            typeDetails,
        );
...
export function isBottomKind<LanguageType>(
    kind: unknown,
): kind is BottomKind<LanguageType> {
    ...
    implements BottomConfigurationChain<LanguageType>
{
    ...
    inferenceRule<T extends LanguageType>(
        ...
        this.typeDetails.inferenceRules.push(
            rule as unknown as InferCurrentTypeRule<BottomType, LanguageType>,
        );
        return this;
    }

    finish(): BottomType {
        const bottomType = new BottomType(
            this.kind as BottomKind<unknown>,
